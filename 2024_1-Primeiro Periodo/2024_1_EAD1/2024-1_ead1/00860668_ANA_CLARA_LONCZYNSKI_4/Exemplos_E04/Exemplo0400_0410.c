...
/**
  Method_05 - Ler valores e contar positivos menores que 100 e pares (alternativo).
 */
void method_05 ( )
{
// definir dado
...
// repetir até desejar parar
	do
	{
		...
		IO_println ( "Opcoes" );
		IO_println ( "0  - Parar" );
		IO_println ( "1  - Repeticao para ler certa quantidade de valore" 		  );
		...
		IO_println ( "10 - Determinar se caractere e' digito"	     );
		IO_println ( "" );
