...
v0.0 falta de ; na linha 37;
v0.1 Nao entendi por que aparece "&x = 000000000061FDDC" no method_01; 
v0.2 OK;
v0.3 Return com valor (0) linha 89;
v0.4 OK;
v0.5 OK;
v0.8 OK;
---------------------------------------------- previsao de testes
...
0.3 03. ( OK ) leitura de um caractere
0.4 04. ( OK )
0.5 05. ( OK )
0.6 06. ( OK )
0.7 07. ( OK )
